function result() {
 ...
 if (isNaN(WtTotaln)) { alert(" Wt. of sample  is not a valid numeral. please enter a valid Numeral"); 
    ...
    alert(" Wt. of sample retained on 75 mm Seive is not a valid numeral. please enter a valid Numeral");
    ...
    alert("Wt of sample retained on 26.5 mm seive is not a valid numeral. please enter a valid Numeral");
 } else if (isNaN(WtSampleRetained11022)){
    alert("Wt of sample retained on 9.5 mm seive is not a valid numeral. please enter a valid Numeral");
    ...
    alert("Wt of sample retained on 2.36 mm seive is not a valid numeral. please enter a valid Numeral");
 }else if (isNaN(WtSampleRetained600micron)){
    alert("Wt of sample retained on 0.85 mm seive is not a valid numeral. please enter a valid Numeral");
 }else if (isNaN(WtSampleRetained75micron)){
    alert("Wt of sample retained on 0.425 mm seive is not a valid numeral. please enter a valid Numeral");
